            ...
            <div className="bg-card rounded-lg shadow-xl w-full max-w-md border border-border">
                <form onSubmit={handleSubmit}>
                    <div className="p-6 border-b border-border">
                        <h2 className="text-2xl font-bold text-foreground">{t('addToWaitlist')}</h2>
                    </div>
                    <div className="p-6 space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-muted-foreground mb-1">{t('customerName')}</label>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-muted-foreground mb-1">{t('quotedWaitTimeMinutes')}</label>
                    ...
                    <div className="p-6 border-t border-border flex justify-end items-center space-x-4">
                        ...
                        <button type="submit" className="px-6 py-2 rounded-md bg-primary text-primary-foreground">{t('addParty')}</button>
                    </div>
                </form>
            </div>
        </div>
