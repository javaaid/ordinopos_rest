            ...
            <div className="w-full max-w-sm bg-card p-6 sm:p-8 rounded-xl shadow-md border border-border">
                <div className="flex flex-col items-center mb-6">
                    {logoError || !settings.receipt.logoUrl ? (
                        <div className="w-20 h-20 mb-4 bg-primary text-primary-foreground flex items-center justify-center rounded-2xl font-bold text-3xl shadow-lg shadow-primary/30">OP</div>
                    ) : (
                        <img 
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="w-full bg-accent border border-border rounded-lg pl-10 pr-4 py-2 text-foreground focus:ring-primary focus:border-primary appearance-none"
                            >
                                {locations.map(l => (
